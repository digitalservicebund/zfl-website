...
eli: "eli/bund/bgbl-1/2008/s1856/2026-07-01/1/deu"
findings:
  - type: "Digitalcheck"
    tag: "Prinzip 1.1"
    id: "520fa8c7-e441-4d1b-bbd2-a72bca2a66c2"
    locationLabel: "§ 22 Abs. 5"
    reasoning: "§ 65a SGB I und § 115 SGB X enthalten sozialrechtsweite Erleichterungen zur elektronischen Mitwirkung bzw. zum Datenaustausch zwischen Behörden; ihr expliziter Ausschluss im Wohngeldverfahren verhindert, dass Antragstellende und die Wohngeldbehörde von diesen bereichsübergreifenden Digitalisierungsvorschriften profitieren."
    hint: "Prüfen, ob der Ausschluss sachlich noch erforderlich ist, oder ob § 65a SGB I und § 115 SGB X (ggf. mit Modifikationen) auch im Wohngeldverfahren nutzbar gemacht werden können."
    quote: "§ 65a des Ersten und § 115 des Zehnten Buches Sozialgesetzbuch sind nicht anzuwenden."
  - type: "Digitalcheck"
    tag: "Prinzip 1.1"
    id: "8e577b1f-7b8a-4a91-8092-0ee5ba9da871"
    locationLabel: "§ 24 Abs. 2 S.1"
    reasoning: "Die Pflicht, den Bewilligungsbescheid „schriftlich“ zu erlassen, kann als Schriftformerfordernis ausgelegt werden, das rein digitale oder vollautomatisierte Bescheiderteilung (z. B. per elektronischem Bescheid oder vollautomatisiertem Verwaltungsakt nach § 35a VwVfG) erschwert, sofern „schriftlich“ nicht ausdrücklich die elektronische Form einschließt."
    hint: "Klarstellen, dass „schriftlich“ auch die elektronische Form (§ 3a VwVfG) bzw. den vollautomatisierten Erlass nach § 35a VwVfG umfasst, oder auf „Textform“ umstellen."
    quote: "Die Entscheidung über den Wohngeldantrag ist durch die Wohngeldbehörde schriftlich zu erlassen."
  - type: "Digitalcheck"
    tag: "Prinzip 2.2"
    id: "042072df-0ec3-4cb6-ab07-0672bacb8316"
    locationLabel: "§ 24 Abs. 4"
    reasoning: "Die manuelle Vorlagepflicht für Einkommensteuerbescheide ignoriert, dass die zugrunde liegenden Daten den Finanzbehörden bereits vorliegen; ein automatisierter Datenaustausch könnte die Vorlage durch die wohngeldberechtigte Person überflüssig machen."
    hint: "Rechtsgrundlage für einen automatisierten Datenabgleich mit den Finanzbehörden schaffen (analog zum bestehenden Datenabgleich nach § 33), statt die Vorlage der Bescheide der wohngeldberechtigten Person aufzuerlegen."
    quote: "die Einkommensteuerbescheide, die den Zeitraum der Wohngeldbewilligung betreffen, unverzüglich der Wohngeldbehörde zur Prüfung, ob ein Fall des § 27 Absatz 2 Satz 1 Nummer 3 vorliegt, vorzulegen sind"
  - type: "Digitalcheck"
    tag: "Prinzip 2.2"
    id: "2ed443e4-f3a0-4898-8a4a-19d49321eecd"
    locationLabel: "§ 23 Abs. 4"
    reasoning: "Kapitalertragsdaten mit Freistellungsauftrag werden bereits nach § 33 Abs. 2 Nr. 2 über das Bundeszentralamt für Steuern automatisiert abgeglichen; das zusätzliche manuelle Auskunftsersuchen nach § 23 Abs. 4 läuft parallel dazu, statt vollständig in den bestehenden automatisierten Abgleich integriert zu sein."
    hint: "Prüfen, ob das Auskunftsersuchen nach § 23 Abs. 4 in den automatisierten Datenabgleich nach § 33 überführt werden kann, um Doppelstrukturen zu vermeiden."
    quote: "sind die Kapitalerträge auszahlenden Stellen, denen ein zu berücksichtigendes Haushaltsmitglied einen Freistellungsauftrag für Kapitalerträge erteilt hat, verpflichtet, der Wohngeldbehörde Auskunft über die Höhe der zugeflossenen Kapitalerträge zu erteilen"
  - type: "Digitalcheck"
    tag: "Prinzip 2.4"
    id: "70cd42d5-3a4b-448d-a575-0ea00dff0ddd"
    locationLabel: "§ 12 Abs. 1"
    reasoning: "Die für die automatisierte Wohngeldberechnung zentralen Höchstbeträge sind nur als Tabelle in einer Gesetzesanlage verankert; ohne begleitende Bereitstellung als maschinenlesbares, versioniertes Datenformat müssen alle Fachverfahren der Länder die Werte bei jeder Fortschreibung (§ 43) manuell nachpflegen."
    hint: "Anlagen 1 bis 3 zusätzlich in einem standardisierten, maschinenlesbaren Format über eine zentrale Schnittstelle bereitstellen, das Fachverfahren automatisiert einlesen können."
    quote: "Die monatlichen Höchstbeträge für Miete und Belastung sind vorbehaltlich des § 11 Absatz 3 nach der Anzahl der zu berücksichtigenden Haushaltsmitglieder und nach der Mietenstufe zu berücksichtigen. Sie ergeben sich aus Anlage 1."
  - type: "Digitalcheck"
    tag: "Prinzip 1.4"
    id: "a7dffbdb-66c4-4036-9300-04428d856758"
    locationLabel: "§ 22 Abs. 1"
    reasoning: "Das Gesetz regelt die Antragstellung, ohne Vorgaben zur barrierefreien Gestaltung des Antragsverfahrens zu treffen, obwohl Wohngeldberechtigte häufig zu vulnerablen Gruppen zählen (z. B. ältere oder pflegebedürftige Personen, vgl. § 17 Nr. 1)."
    hint: "Im Rahmen der Verordnungsermächtigung (§ 38) oder begleitender Verwaltungsvorschriften konkrete Vorgaben zur barrierefreien Gestaltung des Antragsverfahrens nach § 12a BGG verankern."
    quote: "Wohngeld wird nur auf Antrag der wohngeldberechtigten Person geleistet."
  - type: "Digitalcheck"
    tag: "Prinzip 4.4"
    id: "8d085994-8beb-4764-af27-0b623678ad3d"
    locationLabel: "§ 21 Nr. 3"
    reasoning: "Die unbestimmten Rechtsbegriffe „missbräuchlich“ und „erheblichen Vermögens“ erfordern eine Einzelfallwürdigung und verhindern eine vollautomatisierte Entscheidung nach § 35a VwVfG für die sonst weitgehend gebundene Wohngeldberechnung."
    hint: "Konkretisierende Schwellenwerte oder Regelbeispiele für „erhebliches Vermögen“ normieren, um den Anwendungsbereich objektivierbar zu machen."
    quote: "soweit die Inanspruchnahme missbräuchlich wäre, insbesondere wegen erheblichen Vermögens"
  - type: "Digitalcheck"
    tag: "Prinzip 4.2"
    id: "7d683797-b1a8-4803-8a99-5f8b1f238aa1"
    locationLabel: "§ 24 Abs. 1 S.1"
    reasoning: "Die Durchführung ist über Landesrecht dezentral geregelt, wodurch potenziell viele unterschiedliche Wohngeldbehörden mit eigenen IT-Fachverfahren entstehen; dies erschwert eine bundeseinheitliche digitale Umsetzung und den Aufbau zentraler, wiederverwendbarer digitaler Angebote."
    hint: "Im Rahmen abgestimmter IT-Standards (z. B. über die FITKO) auf eine Bündelung der Wohngeld-IT-Fachverfahren bei möglichst wenigen Stellen hinwirken."
    quote: "Zuständig für die Durchführung dieses Gesetzes sind die nach Landesrecht zuständigen Stellen."
  - type: "Bürgercheck"
    tag: "Prinzip 1"
    id: "89ab25be-1229-4d4a-a8af-c255496f05fe"
    locationLabel: "§ 3 Abs. 5"
    reasoning: "Die Regelung unterscheidet sechs verschiedene aufenthaltsrechtliche Kategorien ausländischer Personen, ohne besondere Hürden dieser Zielgruppe (z. B. Sprachbarrieren, fehlende Kenntnis des deutschen Sozialrechts) bei der Antragstellung zu adressieren."
    hint: "Zielgruppenspezifische, mehrsprachige Informationsangebote und Ausfüllhilfen für die Aufenthaltsrechts-Kategorien des § 3 Abs. 5 bereitstellen."
    quote: "Ausländer im Sinne des § 2 Abs. 1 des Aufenthaltsgesetzes (ausländische Personen) sind nach Maßgabe der Absätze 1 bis 4 nur wohngeldberechtigt, wenn sie sich im Bundesgebiet tatsächlich aufhalten und"
  - type: "Bürgercheck"
    tag: "Prinzip 2"
    id: "e6d633b3-5224-42c4-9f34-a49993e3fc0d"
    locationLabel: "§ 14 Abs. 1"
    reasoning: "Die Jahreseinkommensermittlung verweist auf zahlreiche Vorschriften des Einkommensteuergesetzes und listet in Abs. 2 über 30 Einzelfälle; Bürgerinnen und Bürger können ihr eigenes Wohngeld-Einkommen ohne fachkundige Hilfe kaum korrekt ermitteln."
    hint: "Einen verständlichen, interaktiven Online-Einkommensrechner mit Erläuterungen in einfacher Sprache bereitstellen, der die Ausnahmetatbestände automatisch abfragt."
    quote: "Das Jahreseinkommen eines zu berücksichtigenden Haushaltsmitgliedes ist vorbehaltlich des Absatzes 3 die Summe der positiven Einkünfte im Sinne des § 2 Abs. 1 und 2 des Einkommensteuergesetzes zuzüglich der Einnahmen nach Absatz 2 abzüglich der Abzugsbeträge für Steuern und Sozialversicherungsbeiträge (§ 16)."
  - type: "Bürgercheck"
    tag: "Prinzip 2"
    id: "57ad24be-5b7c-49f0-b752-09480047e6bf"
    locationLabel: "§ 19 Abs. 1"
    reasoning: "Die Wohngeldhöhe wird über eine mathematische Formel mit mehreren gesetzesabhängigen Parametern bestimmt, die für juristische und mathematische Laien nicht nachvollziehbar ist und eine eigenständige Einschätzung des Anspruchs verhindert."
    hint: "Einen offiziellen, leicht auffindbaren Online-Wohngeldrechner als verbindliche Ergänzung zur Formel anbieten und im Gesetz bzw. Bewilligungsbescheid darauf verweisen."
    quote: "1,15 · (M – (a + b · M + c · Y) ·Y) Euro."
  - type: "Bürgercheck"
    tag: "Prinzip 2"
    id: "d104b333-d07b-4ea8-8bc2-8f9da2209756"
    locationLabel: "§ 8 Abs. 2"
    reasoning: "Haushaltsmitglieder müssen aktiv auf eine laufende Sozialleistung verzichten, um Wohngeld beantragen zu können, ohne dass das Gesetz eine Beratungspflicht vorsieht, die ihnen hilft abzuschätzen, welche Leistung günstiger ist."
    hint: "Eine Hinweis- und Beratungspflicht der Wohngeldbehörde vor einem Verzicht nach § 8 Abs. 2 normieren, inklusive Vergleichsrechnung der Leistungsansprüche."
    quote: "Verzichten Haushaltsmitglieder auf die Leistungen nach § 7 Abs. 1, um Wohngeld zu beantragen, gilt ihr Ausschluss vom Zeitpunkt der Wirkung des Verzichts an als nicht erfolgt"
  - type: "Bürgercheck"
    tag: "Prinzip 3"
    id: "a52f1d99-3e76-4d05-a3e7-09e2c6437dd5"
    locationLabel: "§ 8 Abs. 1"
    reasoning: "Während des Verwaltungsverfahrens zur Feststellung einer vorrangigen Transferleistung besteht ein genereller Ausschluss vom Wohngeld; bei langen Bearbeitungszeiten der anderen Behörde droht Betroffenen eine finanzielle Übergangslücke ohne jegliche Leistung."
    hint: "Eine Regelung für eine vorläufige Wohngeldzahlung während laufender Verwaltungsverfahren nach § 7 Abs. 1 vorsehen, die im Fall einer späteren Bewilligung der Transferleistung verrechnet wird."
    quote: "Der Ausschluss vom Wohngeld besteht vorbehaltlich des § 7 Abs. 1 Satz 3 Nr. 2 und Abs. 2 Satz 2 Nr. 2 für die Dauer des Verwaltungsverfahrens zur Feststellung von Grund und Höhe der Leistungen nach § 7 Abs. 1."
  - type: "Bürgercheck"
    tag: "Prinzip 3"
    id: "e738fb05-702a-4a06-a31a-6f3231d89d9b"
    locationLabel: "§ 27 Abs. 3"
    reasoning: "Der unbestimmte Rechtsbegriff „unverzüglich\" lässt Betroffene im Unklaren darüber, wie schnell sie geänderte Verhältnisse mitteilen müssen, was bei Unsicherheit zu verspäteten Meldungen und Bußgeldrisiken nach § 37 führen kann."
    hint: "Eine konkrete Frist (z. B. „innerhalb eines Monats\") anstelle von „unverzüglich\" normieren oder im Bewilligungsbescheid eine konkrete Frist kommunizieren."
    quote: "Die wohngeldberechtigte Person muss der Wohngeldbehörde unverzüglich mitteilen, wenn sich im laufenden Bewilligungszeitraum nicht nur vorübergehend"
  - type: "Bürgercheck"
    tag: "Prinzip 4"
    id: "6966a6aa-916a-4b58-870e-1606dacebe59"
    locationLabel: "§ 24 Abs. 1 S.1"
    reasoning: "Die vollständige Delegation der Zuständigkeit an das Landesrecht kann zu sehr unterschiedlichen Formularen, Kontaktwegen und Bearbeitungspraxis zwischen Bundesländern und Kommunen führen, was die Nutzerfreundlichkeit für bundesweit vergleichbare Lebenslagen beeinträchtigt."
    hint: "Bundeseinheitliche Mindeststandards für den Kontaktpunkt (z. B. ein einheitliches Online-Antragsformular) im Rahmen der Verordnungsermächtigung nach § 38 verankern."
    quote: "Zuständig für die Durchführung dieses Gesetzes sind die nach Landesrecht zuständigen Stellen."
  - type: "Bürgercheck"
    tag: "Prinzip 5"
    id: "baa98811-c53b-4ac7-aa6a-4d9ccd9754b1"
    locationLabel: "§ 21 Nr. 3"
    reasoning: "Die unbestimmten Rechtsbegriffe „missbräuchlich\" und „erheblichen Vermögens\" machen für Bürgerinnen und Bürger im Vorfeld kaum vorhersehbar, ob ihr Antrag an dieser Ausnahme scheitert, was Rechtsunsicherheit und Frustration erzeugt."
    hint: "Konkrete Vermögensschwellenwerte oder Regelbeispiele normieren, damit Betroffene ihre Anspruchschancen selbst einschätzen können."
    quote: "soweit die Inanspruchnahme missbräuchlich wäre, insbesondere wegen erheblichen Vermögens"
  - type: "Bürgercheck"
    tag: "Prinzip 5"
    id: "4094464e-7d6b-4699-a05e-1eaac73525e5"
    locationLabel: "§ 11 Abs. 3"
    reasoning: "Die anteilige Berechnung von Miete und Höchstbeträgen bei gemischten Haushalten (teils vom Wohngeld ausgeschlossene Mitglieder) ist rechnerisch komplex und für Betroffene ohne Beispielrechnung kaum nachvollziehbar."
    hint: "Anschauliche Berechnungsbeispiele für gemischte Haushalte in Ausfüllhilfen oder einem Online-Rechner bereitstellen."
    quote: "Ist mindestens ein Haushaltsmitglied vom Wohngeld ausgeschlossen, ist nur der Anteil der Miete oder Belastung zu berücksichtigen, der dem Anteil der zu berücksichtigenden Haushaltsmitglieder an der Gesamtzahl der Haushaltsmitglieder entspricht."
---


Wohngeldgesetz (WoGG)Wohngeldgesetz
(WoGG)

Textnachweis ab: 1.1.2009EU-Vollzitate: vgl. Liste EU-Rechtsakte G v. 4.2.2026 I Nr. 33

WoGGVollzitatWohngeldgesetz vom 24. September 2008 (BGBl. I S. 1856), das zuletzt durch Artikel 11 Absatz 8 des Gesetzes vom 16. April 2026 (BGBl. 2026 I Nr. 107) geändert worden istStandangabeZuletzt geändert durch Art. 11 Abs. 8 G v. 16.4.2026 I Nr. 107
...
Teil 1Zweck des Wohngeldes und Wohngeldberechtigung§ 1 Zweck des Wohngeldes
...
(5)<!--finding:89ab25be-1229-4d4a-a8af-c255496f05fe:start-->Ausländer im Sinne des § 2 Abs. 1 des Aufenthaltsgesetzes (ausländische Personen) sind nach Maßgabe der Absätze 1 bis 4 nur wohngeldberechtigt, wenn sie sich im Bundesgebiet tatsächlich aufhalten und<!--finding:89ab25be-1229-4d4a-a8af-c255496f05fe:end-->
...
Teil 2Berechnung und Höhe des WohngeldesKapitel 1Berechnungsgrößen des Wohngeldes§ 4 Berechnungsgrößen des Wohngeldes
...
Kapitel 2Haushaltsmitglieder§ 5 Haushaltsmitglieder
...
§ 8 Dauer des Ausschlusses vom Wohngeld und Verzicht auf Leistungen
(1)<!--finding:a52f1d99-3e76-4d05-a3e7-09e2c6437dd5:start-->Der Ausschluss vom Wohngeld besteht vorbehaltlich des § 7 Abs. 1 Satz 3 Nr. 2 und Abs. 2 Satz 2 Nr. 2 für die Dauer des Verwaltungsverfahrens zur Feststellung von Grund und Höhe der Leistungen nach § 7 Abs. 1.<!--finding:a52f1d99-3e76-4d05-a3e7-09e2c6437dd5:end--> Der Ausschluss besteht vorbehaltlich des § 7 Abs. 1 Satz 3 Nr. 2 und Abs. 2 Satz 2 Nr. 2
...
(2)<!--finding:d104b333-d07b-4ea8-8bc2-8f9da2209756:start-->Verzichten Haushaltsmitglieder auf die Leistungen nach § 7 Abs. 1, um Wohngeld zu beantragen, gilt ihr Ausschluss vom Zeitpunkt der Wirkung des Verzichts an als nicht erfolgt<!--finding:d104b333-d07b-4ea8-8bc2-8f9da2209756:end-->; § 46 Abs. 2 des Ersten Buches Sozialgesetzbuch ist in diesem Fall nicht anzuwenden.

Kapitel 3Miete und Belastung§ 9 Miete
...
(3)<!--finding:4094464e-7d6b-4699-a05e-1eaac73525e5:start-->Ist mindestens ein Haushaltsmitglied vom Wohngeld ausgeschlossen, ist nur der Anteil der Miete oder Belastung zu berücksichtigen, der dem Anteil der zu berücksichtigenden Haushaltsmitglieder an der Gesamtzahl der Haushaltsmitglieder entspricht.<!--finding:4094464e-7d6b-4699-a05e-1eaac73525e5:end--> In diesem Fall sind nur der Anteil des Höchstbetrages nach § 12 Absatz 1, der Anteil des Gesamtbetrages zur Entlastung bei den Heizkosten nach § 12 Absatz 6 und der Anteil des Betrages der Klimakomponente nach § 12 Absatz 7 zu berücksichtigen, der jeweils dem Anteil der zu berücksichtigenden Haushaltsmitglieder an der Gesamtzahl der Haushaltsmitglieder entspricht. Für die Ermittlung des Höchstbetrages nach § 12 Absatz 1, des Gesamtbetrages zur Entlastung bei den Heizkosten nach § 12 Absatz 6 und des Betrages der Klimakomponente nach § 12 Absatz 7 ist jeweils die Gesamtzahl der Haushaltsmitglieder maßgebend.

§ 12 Höchstbeträge für Miete und Belastung sowie Entlastung bei den Heizkosten und die Klimakomponente
(1)<!--finding:70cd42d5-3a4b-448d-a575-0ea00dff0ddd:start-->Die monatlichen Höchstbeträge für Miete und Belastung sind vorbehaltlich des § 11 Absatz 3 nach der Anzahl der zu berücksichtigenden Haushaltsmitglieder und nach der Mietenstufe zu berücksichtigen. Sie ergeben sich aus Anlage 1.<!--finding:70cd42d5-3a4b-448d-a575-0ea00dff0ddd:end-->
...
Kapitel 4Einkommen§ 13 Gesamteinkommen
...
§ 14 Jahreseinkommen
(1)<!--finding:e6d633b3-5224-42c4-9f34-a49993e3fc0d:start-->Das Jahreseinkommen eines zu berücksichtigenden Haushaltsmitgliedes ist vorbehaltlich des Absatzes 3 die Summe der positiven Einkünfte im Sinne des § 2 Abs. 1 und 2 des Einkommensteuergesetzes zuzüglich der Einnahmen nach Absatz 2 abzüglich der Abzugsbeträge für Steuern und Sozialversicherungsbeiträge (§ 16).<!--finding:e6d633b3-5224-42c4-9f34-a49993e3fc0d:end--> Bei den Einkünften im Sinne des § 2 Abs. 1 Satz 1 Nr. 1 bis 3 des Einkommensteuergesetzes ist § 7g Abs. 1 bis 4 und 7 des Einkommensteuergesetzes nicht anzuwenden. Von den Einkünften aus nichtselbständiger Arbeit, die nach dem Einkommensteuergesetz vom Arbeitgeber pauschal besteuert werden, zählen zum Jahreseinkommen nur
...
Kapitel 5Höhe des Wohngeldes§ 19 Höhe des Wohngeldes
(1)Das ungerundete monatliche Wohngeld für bis zu zwölf zu berücksichtigende Haushaltsmitglieder beträgt
<!--finding:57ad24be-5b7c-49f0-b752-09480047e6bf:start-->1,15 · (M – (a + b · M + c · Y) ·Y) Euro.<!--finding:57ad24be-5b7c-49f0-b752-09480047e6bf:end-->
...
Teil 3Nichtbestehen des Wohngeldanspruchs§ 20 Gesetzeskonkurrenz
(1)(weggefallen)
...
3.<!--finding:8d085994-8beb-4764-af27-0b623678ad3d:start--><!--finding:baa98811-c53b-4ac7-aa6a-4d9ccd9754b1:start-->soweit die Inanspruchnahme missbräuchlich wäre, insbesondere wegen erheblichen Vermögens<!--finding:baa98811-c53b-4ac7-aa6a-4d9ccd9754b1:end--><!--finding:8d085994-8beb-4764-af27-0b623678ad3d:end-->.

Teil 4Bewilligung, Zahlung und Änderung des Wohngeldes§ 22 Wohngeldantrag
(1)<!--finding:a7dffbdb-66c4-4036-9300-04428d856758:start-->Wohngeld wird nur auf Antrag der wohngeldberechtigten Person geleistet.<!--finding:a7dffbdb-66c4-4036-9300-04428d856758:end-->
...
(5)<!--finding:520fa8c7-e441-4d1b-bbd2-a72bca2a66c2:start-->§ 65a des Ersten und § 115 des Zehnten Buches Sozialgesetzbuch sind nicht anzuwenden.<!--finding:520fa8c7-e441-4d1b-bbd2-a72bca2a66c2:end-->
...
(4)Zur Aufdeckung rechtswidriger Inanspruchnahme von Wohngeld <!--finding:2ed443e4-f3a0-4898-8a4a-19d49321eecd:start-->sind die Kapitalerträge auszahlenden Stellen, denen ein zu berücksichtigendes Haushaltsmitglied einen Freistellungsauftrag für Kapitalerträge erteilt hat, verpflichtet, der Wohngeldbehörde Auskunft über die Höhe der zugeflossenen Kapitalerträge zu erteilen<!--finding:2ed443e4-f3a0-4898-8a4a-19d49321eecd:end-->. § 21 Absatz 3 Satz 4 des Zehnten Buches Sozialgesetzbuch gilt entsprechend. Ein Auskunftsersuchen der Wohngeldbehörde ist nur zulässig, wenn auf Grund eines Datenabgleichs nach § 33 der Verdacht besteht oder feststeht, dass Wohngeld rechtswidrig in Anspruch genommen wurde oder wird und dass das zu berücksichtigende Haushaltsmitglied, auch soweit es dazu berechtigt ist, nicht oder nicht vollständig bei der Ermittlung der Kapitalerträge mitwirkt. Die Auslagen für Auskünfte von Kapitalerträge auszahlenden Stellen, die durch die Ermittlung der rechtswidrigen Inanspruchnahme von Wohngeld entstanden sind, sollen abweichend von § 64 Absatz 1 des Zehnten Buches Sozialgesetzbuch von der Person, die Wohngeld zu erstatten hat, erhoben werden.
...
(3)<!--finding:e738fb05-702a-4a06-a31a-6f3231d89d9b:start-->Die wohngeldberechtigte Person muss der Wohngeldbehörde unverzüglich mitteilen, wenn sich im laufenden Bewilligungszeitraum nicht nur vorübergehend<!--finding:e738fb05-702a-4a06-a31a-6f3231d89d9b:end-->
...
Teil 5Kostentragung und Datenabgleich§ 32 Erstattung des Wohngeldes durch den Bund
...
Teil 6Wohngeldstatistik§ 34 Zweck der Wohngeldstatistik, Auskunfts- und Hinweispflicht
...
Teil 7Schlussvorschriften§ 37 Bußgeld
...
Teil 8Überleitungsvorschriften§ 42 Gesetz zur Neuregelung des Wohngeldrechts und zur Änderung des Sozialgesetzbuches
...
1.1.2022 vgl. § 23 WoGV idF d. Art. 1 Nr. 2 V v. 3.6.2021 I 1369 (1. WoGFV)
