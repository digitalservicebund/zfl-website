...
eli: "eli/bund/bgbl-1/2017/s3138/2026-07-29/1/deu"
findings:
  - type: "Digitalcheck"
    tag: "Prinzip 2.4"
    id: "a6a2ed89-54c8-4c35-bbec-085e1fa5d515"
    locationLabel: "§ 4 Abs. 1 Satz 3"
    reasoning: "Die Länder dürfen von den per Rechtsverordnung vorgegebenen IT-Komponenten abweichen, sofern sie eigene, für den Portalverbund geeignete Komponenten bereitstellen. Das öffnet die Tür für uneinheitliche technische Umsetzungen zwischen den Ländern."
    hint: "Abweichungsspielraum der Länder an verbindliche Mindest-Interoperabilitätskriterien koppeln (z. B. Pflicht zur Kompatibilität mit den zentral festgelegten Schnittstellenstandards nach § 6), statt nur allgemein 'geeignete IT-Komponenten' zu verlangen."
    quote: "Die Länder können von den in der Rechtsverordnung getroffenen Regelungen durch Landesrecht abweichen, soweit sie für den Betrieb im Portalverbund geeignete IT-Komponenten bereitstellen."
  - type: "Digitalcheck"
    tag: "Prinzip 3.2"
    id: "9144f827-c455-4d61-a4b9-de4e524798b5"
    locationLabel: "§ 4 Abs. 3"
    reasoning: "Die Präferenz für offene Standards, offene Schnittstellen und Open-Source-Software ist als bloße Soll-Vorschrift formuliert und damit rechtlich nicht verbindlich durchsetzbar."
    hint: "Die Soll-Vorschrift durch klare Kriterien ergänzen, unter denen ausnahmsweise von offenen Standards/Open-Source abgewichen werden darf (Regel-Ausnahme-Verhältnis statt bloßer Empfehlung), um Lock-in-Effekte wirksamer zu vermeiden."
    quote: "sollen offene Standards und offene Schnittstellen verwendet werden und soll Open-Source-Software vorrangig vor solcher Software eingesetzt werden, deren Quellcode nicht öffentlich zugänglich ist oder deren Lizenz die Verwendung, Weitergabe und Veränderung einschränkt."
  - type: "Digitalcheck"
    tag: "Prinzip 2.5"
    id: "3041837e-2db1-4622-940f-9b52f11ff7f0"
    locationLabel: "§ 1a Abs. 5"
    reasoning: "Die Festlegung der IT-Komponenten für das Bundesportal (Bundesministerium für Verkehr im Einvernehmen mit dem Bundesministerium für Digitalisierung) und für das Länderportal (Bundesministerium für Digitalisierung im Einvernehmen mit dem IT-Planungsrat) erfolgt in getrennten Zuständigkeiten. Ohne einen gemeinsamen frühzeitigen Abstimmungsprozess besteht das Risiko inkompatibler Komponenten zwischen Bundes- und Länderportal."
    hint: "Einen verbindlichen, frühzeitigen gemeinsamen Abstimmungsprozess (z. B. über den IT-Planungsrat) für beide Zuständigkeitsstränge vorsehen, um die Vereinbarkeit der jeweiligen IT-Komponenten von Beginn an sicherzustellen."
    quote: "Die IT-Komponenten für das Verwaltungsportal des Bundes inklusive der dazugehörigen Datenplattform legt das Bundesministerium für Verkehr im Einvernehmen mit dem Bundesministerium für Digitalisierung und Staatsmodernisierung fest. Die IT-Komponenten für das Verwaltungsportal der Länder inklusive der dazugehörigen Datenplattform legt das Bundesministerium für Digitalisierung und Staatsmodernisierung im Einvernehmen mit dem IT-Planungsrat durch Rechtsverordnung mit Zustimmung des Bundesrates fest."
  - type: "Digitalcheck"
    tag: "Prinzip 4.2"
    id: "6c851d30-26d8-48df-88b2-b12d5869a83f"
    locationLabel: "§ 1a Abs. 3"
    reasoning: "Die technische und organisatorische Anbindung von Gemeinden, Gemeindeverbänden und sonstigen kommunalen Stellen an den Portalverbund wird jedem Land einzeln zur Sicherstellung übertragen. Bei tausenden Kommunen bundesweit droht dadurch redundanter Aufwand statt gebündelter Umsetzung."
    hint: "Zentrale, länderübergreifend nutzbare Basisdienste/Komponenten für die kommunale Anbindung bereitstellen, die Länder und Kommunen übernehmen können, statt die Anbindung dezentral in jedem Land separat zu organisieren."
    quote: "Die Länder sind verpflichtet, die technischen und organisatorischen Voraussetzungen für die Anbindung der Gemeinden und Gemeindeverbände sowie der sonstigen der Aufsicht des Landes unterstehenden juristischen Personen des öffentlichen Rechts an den Portalverbund sicherzustellen."
  - type: "Digitalcheck"
    tag: "Prinzip 1.4"
    id: "ab370dff-0f58-4600-af78-3dd3610da87e"
    locationLabel: "§ 3a Abs. 1"
    reasoning: "Für das Beratungsangebot im Portalverbund wird nur 'barrierearme' statt 'barrierefreie' Gestaltung verlangt, während § 7 Abs. 2 für den übergreifenden Zugang zu elektronischen Verwaltungsleistungen ausdrücklich Barrierefreiheit fordert. Das erzeugt ein uneinheitliches Schutzniveau zwischen Portalzugang und Beratungsangebot."
    hint: "Die Formulierung an § 7 Abs. 2 angleichen und für das Beratungsangebot ebenfalls volle Barrierefreiheit nach Maßgabe der Barrierefreie-Informationstechnik-Verordnung bzw. § 12a BGG vorschreiben statt nur 'barrierearm'."
    quote: "Bund und Länder stellen für Nutzer im Portalverbund eine allgemeine fachunabhängige, barrierearme Beratung für die Abwicklung ihrer über Verwaltungsportale angebotenen, elektronischen Verwaltungsleistungen bereit und bestimmen dafür öffentliche Stellen."
  - type: "Digitalcheck"
    tag: "Prinzip 1.1"
    id: "d50117c5-ecd6-48f6-a2b5-368665c1d8dd"
    locationLabel: "§ 10 Abs. 3"
    reasoning: "Für Registrierung und Nutzung des Datenschutzcockpits wird durchgängig das Vertrauensniveau 'hoch' verlangt. Das setzt ein entsprechendes Identifizierungsmittel (z. B. eID-Funktion) voraus und kann Nutzer ohne ein solches Mittel faktisch vom Zugang zu ihrem eigenen Datenschutzcockpit ausschließen."
    hint: "Prüfen, ob für bestimmte, weniger sicherheitskritische Funktionen des Datenschutzcockpits auch ein niedrigeres, breiter verfügbares Vertrauensniveau ausreicht, oder alternative, gleichwertig sichere Identifizierungswege eröffnen."
    quote: "Sie hat sich bei der Registrierung und Nutzung des Datenschutzcockpits mit einem Identifizierungsmittel auf dem Vertrauensniveau hoch zu identifizieren."
  - type: "Digitalcheck"
    tag: "Prinzip 2.4"
    id: "277448d9-17d8-4ad9-9003-302e1c975ef4"
    locationLabel: "§ 12 Abs. 1"
    reasoning: "Während der dreijährigen Übergangsfrist dürfen Identifizierung, Authentifizierung und Kommunikation weiterhin über die bisherigen, uneinheitlichen Nutzerkonten und Postfächer der Länder oder Fachportale erfolgen, statt einheitlich über das zentrale Bürgerkonto. Das verlängert die parallele Nutzung nicht standardisierter Altsysteme."
    hint: "Für die Übergangsphase Mindestanforderungen an die Interoperabilität der Alt-Nutzerkonten mit dem zentralen Bürgerkonto festlegen und die Migration mit klaren Zwischenzielen (nicht nur einem Enddatum) versehen."
    quote: "Für einen Übergangszeitraum von drei Jahren kann die Identifizierung und Authentifizierung sowie die bidirektionale Kommunikation der Nutzer im Sinne des § 2 Absatz 4 Nummer 1 für elektronische Verwaltungsleistungen im Portalverbund auch über die bisherigen Nutzerkonten und Postfächer der Länder oder eines Fachportals erfolgen."
  - type: "Digitalcheck"
    tag: "Prinzip 3.1"
    id: "406402d1-4342-43c9-8e5e-71c20f3fd4fd"
    locationLabel: "§ 12 Abs. 4"
    reasoning: "Öffentliche Stellen sind für Verwaltungsleistungen im Rahmen bestimmter EU-Förderprogramme bis Ende 2031 von der Pflicht zur Nutzung des einheitlichen Organisationskontos ausgenommen. Diese lange Ausnahmefrist verzögert die flächendeckende Etablierung der zentralen Lösung in einem wirtschaftlich bedeutsamen Bereich erheblich."
    hint: "Die Ausnahmefrist verkürzen oder an konkrete, überprüfbare Meilensteine der technischen Anbindungsfähigkeit koppeln statt an ein pauschales Kalenderdatum."
    quote: "Öffentliche Stellen sind von der Verpflichtung nach § 3 Absatz 3 bis einschließlich 31. Dezember 2031 ausgenommen in Bezug auf elektronische Verwaltungsleistungen, die der Durchführung"
  - type: "Digitalcheck"
    tag: "Prinzip 4.5"
    id: "39a93bc1-e673-4076-8969-205d13f1f5f0"
    locationLabel: "§ 2 Abs. 9"
    reasoning: "Die Definition von 'Behörde' als 'jede Stelle, die Aufgaben der öffentlichen Verwaltung wahrnimmt' ist sehr weit und unscharf gefasst. Für eine automatisierte Bestimmung des Anwendungsbereichs (z. B. wer zur Anbindung an den Portalverbund verpflichtet ist) ist diese Offenheit hinderlich."
    hint: "Auf eine bestehende, präzisere Begriffsbestimmung verweisen (z. B. § 1 Abs. 4 VwVfG) oder die Definition um konkretere Abgrenzungskriterien ergänzen."
    quote: "Behörde im Sinne dieses Gesetzes ist jede Stelle, die Aufgaben der öffentlichen Verwaltung wahrnimmt."
  - type: "Digitalcheck"
    tag: "Prinzip 1.5"
    id: "e07aa823-9b05-4477-8f49-1965d2933101"
    locationLabel: "§ 7 Abs. 1"
    reasoning: "Die allgemeine Nutzerfreundlichkeitsklausel verlangt zwar eine einfache und intuitive Bedienbarkeit, adressiert aber nicht ausdrücklich Mehrsprachigkeit oder verständliche Sprache, obwohl der Nutzerkreis des Gesetzes ausdrücklich auch Personen mit Aufenthaltstitel (vgl. § 8 Abs. 1 Nr. 1, Verweis auf das Aufenthaltsgesetz) umfasst."
    hint: "Die Nutzerfreundlichkeitsanforderung um eine ausdrückliche Vorgabe zu verständlicher, ggf. mehrsprachiger Sprache ergänzen, analog zu bestehenden Regelungen zu Leichter Sprache."
    quote: "Bund und Länder stellen durch geeignete Maßnahmen die Nutzerfreundlichkeit sowie eine einfache und intuitive Bedienbarkeit des übergreifenden Zugangs zu elektronischen Verwaltungsleistungen, einschließlich der für diesen Zugang relevanten IT-Komponenten, sicher."
  - type: "Bürgercheck"
    tag: "Prinzip 4"
    id: "ab4b7ded-492b-46ab-8a7f-7f25162b66c6"
    locationLabel: "§ 1a Abs. 2"
    reasoning: "Nutzer erhalten einen gesetzlichen Anspruch auf elektronischen Zugang, aber Schadens- und Entschädigungsansprüche bei Nichterfüllung sind ausgeschlossen — der zentrale Kontaktpunkt zwischen Bürger:in und Verwaltung (der Anspruch selbst) bleibt damit praktisch folgenlos durchsetzbar."
    hint: "Den Anspruch um ein alternatives, niedrigschwelliges Beschwerde- oder Eskalationsverfahren ergänzen, über das Nutzer die Nichterfüllung praktisch geltend machen können, auch ohne Schadensersatzklage."
    quote: "Nach Ablauf des vierten auf die Verkündung des Gesetzes vom 19. Juli 2024 (BGBl. 2024 I Nr. 245) folgenden Kalenderjahres haben Nutzer einen Anspruch auf einen elektronischen Zugang zu den Verwaltungsleistungen des Bundes. Schadensersatzansprüche und Entschädigungsansprüche sind ausgeschlossen."
  - type: "Bürgercheck"
    tag: "Prinzip 2"
    id: "2e70cadd-1d8d-4782-8993-dbc825bfad1f"
    locationLabel: "§ 3 Abs. 4 Nr. 1 b)"
    reasoning: "Um festzustellen, welches Identifizierungsmittel für welche Leistung ausreicht, müssen Nutzer:innen drei verschiedene Gesetze und eine EU-Verordnung samt Vertrauensniveau-Systematik durchdringen — das übersteigt die Handlungsfähigkeit der meisten Bürgerinnen und Bürger bei der eigenständigen Nutzung."
    hint: "Eine laienverständliche Zusammenfassung ('Was brauche ich für welchen Antrag?') im Portal bereitstellen und die Vertrauensniveau-Logik dort statt nur im Gesetzestext erklären."
    quote: "durch einen elektronischen Identitätsnachweis nach § 18 des Personalausweisgesetzes, nach § 12 des eID-Karte-Gesetzes oder nach § 78 Absatz 5 des Aufenthaltsgesetzes oder durch ein anderes elektronisches Identifizierungsmittel, welches nach Artikel 6 der Verordnung (EU) Nr. 910/2014 mit dem Sicherheitsniveau „hoch“ im Sinne des Artikels 8 Absatz 2 Buchstabe c der Verordnung (EU) 910/2014 anerkannt worden ist"
  - type: "Bürgercheck"
    tag: "Prinzip 1"
    id: "8be8659f-8483-45e2-b35f-72f6ef8715c7"
    locationLabel: "§ 3a Abs. 1"
    reasoning: "Die Beratung ist bewusst allgemein und fachunabhängig gehalten, ohne dass besondere Zielgruppen (z. B. Menschen mit geringer digitaler Kompetenz, Sprachbarrieren oder Behinderungen) mit spezifischem Unterstützungsbedarf benannt oder adressiert werden."
    hint: "Im Vollzug (z. B. per Verwaltungsvereinbarung) gezielte Beratungsangebote oder -kanäle für besonders betroffene Teilgruppen vorsehen, statt es bei einem allgemeinen Angebot zu belassen."
    quote: "Bund und Länder stellen für Nutzer im Portalverbund eine allgemeine fachunabhängige, barrierearme Beratung für die Abwicklung ihrer über Verwaltungsportale angebotenen, elektronischen Verwaltungsleistungen bereit und bestimmen dafür öffentliche Stellen."
  - type: "Bürgercheck"
    tag: "Prinzip 3"
    id: "c8195291-b907-4cae-a23d-d6090e5b0f8e"
    locationLabel: "§ 8 Abs. 7"
    reasoning: "Eine rein elektronische Vorab-Benachrichtigung übersieht, dass Nutzer:innen gerade wegen längerer Inaktivität (Krankheit, Auslandsaufenthalt, fehlende Routine) die Benachrichtigung leicht verpassen und dann unerwartet ihr Konto samt gespeicherter Daten verlieren können."
    hint: "Zusätzlich zur elektronischen Benachrichtigung einen zweiten, robusteren Kanal vorsehen (z. B. Postweg oder verlängerte Fristen bei fehlender Reaktion) und die Frist vor Löschung verlängern."
    quote: "Das Bürgerkonto wird bei zweijähriger Inaktivität des Nutzers automatisch gelöscht. Der Nutzer wird zwei Monate vorher automatisch elektronisch über die anstehende Löschung benachrichtigt."
  - type: "Bürgercheck"
    tag: "Prinzip 2"
    id: "3157087d-8b22-4bf0-bede-4f886045646f"
    locationLabel: "§ 9 Abs. 1 Satz 2"
    reasoning: "Die Einwilligung zur elektronischen Bekanntgabe von Verwaltungsakten gilt als Opt-out-Standard — Nutzer:innen müssen aktiv wissen, dass und wie sie widersprechen können, sonst erhalten sie ggf. fristauslösende Bescheide unbemerkt nur elektronisch."
    hint: "Bei der erstmaligen Antragstellung aktiv und unübersehbar auf die Opt-out-Möglichkeit sowie deren Konsequenzen hinweisen, statt die Einwilligung stillschweigend vorauszusetzen."
    quote: "Die Einwilligung nach Satz 1 gilt als erteilt, sofern der Nutzer nicht im Rahmen der Inanspruchnahme einer elektronischen Verwaltungsleistung eine elektronische Bekanntgabe über ein Postfach im Sinne des § 2 Absatz 7 ausschließt."
  - type: "Bürgercheck"
    tag: "Prinzip 3"
    id: "8d827856-36ba-4412-b484-f2865167665a"
    locationLabel: "§ 9 Abs. 1 Satz 4"
    reasoning: "Die Zugangsfiktion nach vier Tagen läuft unabhängig davon, ob die betroffene Person in dieser Zeit tatsächlich Zugriff auf ihr Postfach hatte — bei Krankheit, Reisen oder anderen Lebenslagen können so Fristen zu laufen beginnen, bevor der Bescheid überhaupt wahrgenommen wurde."
    hint: "Eine aktive Hinweisbenachrichtigung (z. B. SMS/E-Mail zusätzlich zur reinen Bereitstellung) mit Lesebestätigung vorsehen oder die Fiktionsfrist bei nachgewiesener Verhinderung hemmen."
    quote: "Der Verwaltungsakt gilt am vierten Tag nach der Bereitstellung zum Abruf als bekannt gegeben."
  - type: "Bürgercheck"
    tag: "Prinzip 2"
    id: "b4136441-179d-450d-949e-b20b233b3965"
    locationLabel: "§ 10 Abs. 4"
    reasoning: "Die Regelung verlangt von Nutzer:innen eine eigenständige Konfiguration von Umfang und Anzeige ihrer Protokolldaten, ohne dass im Gesetzestext eine verständliche Voreinstellung oder Anleitung für diese datenschutzrechtlich anspruchsvolle Entscheidung vorgesehen ist."
    hint: "Eine nutzerfreundliche Voreinstellung (z. B. maximale Transparenz als Standard) sowie eine verständliche Erklärhilfe im Datenschutzcockpit selbst vorsehen, statt die Konfiguration voraussetzungslos den Nutzer:innen zu überlassen."
    quote: "Der Nutzer legt fest, in welchem Umfang das Datenschutzcockpit Protokolldaten einschließlich der übermittelten Inhaltsdaten sowie die Bestandsdaten der Register nach Absatz 2 erheben und anzeigen darf."
  - type: "Bürgercheck"
    tag: "Prinzip 5"
    id: "c1af5eaa-c3f4-49d1-9213-e6550b42f597"
    locationLabel: "§ 12 Abs. 1"
    reasoning: "Während der Übergangsfrist gelten je nach Land oder Fachportal unterschiedliche Nutzerkonten parallel, wobei der genaue Fristbeginn erst später per Bekanntmachung feststeht — für Bürger:innen ist so zeitweise unklar, welches Konto 'für sie' gilt."
    hint: "Für Bürger:innen eine zentrale, laufend aktualisierte Übersicht bereitstellen, welches Nutzerkonto in ihrem Land/Verfahren aktuell gilt, statt dies implizit aus verstreuten Bekanntmachungen ableiten zu müssen."
    quote: "Für einen Übergangszeitraum von drei Jahren kann die Identifizierung und Authentifizierung sowie die bidirektionale Kommunikation der Nutzer im Sinne des § 2 Absatz 4 Nummer 1 für elektronische Verwaltungsleistungen im Portalverbund auch über die bisherigen Nutzerkonten und Postfächer der Länder oder eines Fachportals erfolgen."
---

Gesetz zur Verbesserung des Onlinezugangs zu Verwaltungsleistungen (OZG)Gesetz zur Verbesserung des Onlinezugangs zu Verwaltungsleistungen
(Onlinezugangsgesetz - OZG)

Textnachweis ab: 18.8.2017Zur Anwendung vgl. §§ 5, 6
OZGVollzitatOnlinezugangsgesetz vom 14. August 2017 (BGBl. I S. 3122, 3138), das zuletzt durch Artikel 21 des Gesetzes vom 22. Juli 2026 (BGBl. 2026 I Nr. 224) geändert worden istStandangabeZuletzt geändert durch Art. 1 G v. 19.7.2024 I Nr. 245Änderung durch Art. 21 G v. 22.7.2026 I Nr. 224 textlich nachgewiesen, dokumentarisch noch nicht abschließend bearbeitet§ 1 Anwendungsbereich
...
(2)<!--finding:ab4b7ded-492b-46ab-8a7f-7f25162b66c6:start-->Nach Ablauf des vierten auf die Verkündung des Gesetzes vom 19. Juli 2024 (BGBl. 2024 I Nr. 245) folgenden Kalenderjahres haben Nutzer einen Anspruch auf einen elektronischen Zugang zu den Verwaltungsleistungen des Bundes. Schadensersatzansprüche und Entschädigungsansprüche sind ausgeschlossen.<!--finding:ab4b7ded-492b-46ab-8a7f-7f25162b66c6:end-->

(3)Bund und Länder sind verpflichtet, ihre Verwaltungsportale miteinander zu einem Portalverbund zu verknüpfen, sodass Nutzer über alle Verwaltungsportale von Bund und Ländern einen medienbruch- und barrierefreien Zugang zu elektronischen Verwaltungsleistungen dieser Verwaltungsträger erhalten. <!--finding:6c851d30-26d8-48df-88b2-b12d5869a83f:start-->Die Länder sind verpflichtet, die technischen und organisatorischen Voraussetzungen für die Anbindung der Gemeinden und Gemeindeverbände sowie der sonstigen der Aufsicht des Landes unterstehenden juristischen Personen des öffentlichen Rechts an den Portalverbund sicherzustellen.<!--finding:6c851d30-26d8-48df-88b2-b12d5869a83f:end-->
...
(5)Bund und Länder verknüpfen ihre Verwaltungsportale nach § 72a Absatz 2 VwVfG bis spätestens zum 31. Dezember 2027 zu einem gemeinsamen Verwaltungsportal. <!--finding:3041837e-2db1-4622-940f-9b52f11ff7f0:start-->Die IT-Komponenten für das Verwaltungsportal des Bundes inklusive der dazugehörigen Datenplattform legt das Bundesministerium für Verkehr im Einvernehmen mit dem Bundesministerium für Digitalisierung und Staatsmodernisierung fest. Die IT-Komponenten für das Verwaltungsportal der Länder inklusive der dazugehörigen Datenplattform legt das Bundesministerium für Digitalisierung und Staatsmodernisierung im Einvernehmen mit dem IT-Planungsrat durch Rechtsverordnung mit Zustimmung des Bundesrates fest.<!--finding:3041837e-2db1-4622-940f-9b52f11ff7f0:end-->
...
(9)<!--finding:39a93bc1-e673-4076-8969-205d13f1f5f0:start-->Behörde im Sinne dieses Gesetzes ist jede Stelle, die Aufgaben der öffentlichen Verwaltung wahrnimmt.<!--finding:39a93bc1-e673-4076-8969-205d13f1f5f0:end-->
...
b)für elektronische Verwaltungsleistungen, für die das Vertrauensniveau „hoch“ erforderlich ist, <!--finding:2e70cadd-1d8d-4782-8993-dbc825bfad1f:start-->durch einen elektronischen Identitätsnachweis nach § 18 des Personalausweisgesetzes, nach § 12 des eID-Karte-Gesetzes oder nach § 78 Absatz 5 des Aufenthaltsgesetzes oder durch ein anderes elektronisches Identifizierungsmittel, welches nach Artikel 6 der Verordnung (EU) Nr. 910/2014 mit dem Sicherheitsniveau „hoch“ im Sinne des Artikels 8 Absatz 2 Buchstabe c der Verordnung (EU) 910/2014 anerkannt worden ist<!--finding:2e70cadd-1d8d-4782-8993-dbc825bfad1f:end-->, und
...
(1)<!--finding:ab370dff-0f58-4600-af78-3dd3610da87e:start--><!--finding:8be8659f-8483-45e2-b35f-72f6ef8715c7:start-->Bund und Länder stellen für Nutzer im Portalverbund eine allgemeine fachunabhängige, barrierearme Beratung für die Abwicklung ihrer über Verwaltungsportale angebotenen, elektronischen Verwaltungsleistungen bereit und bestimmen dafür öffentliche Stellen.<!--finding:8be8659f-8483-45e2-b35f-72f6ef8715c7:end--><!--finding:ab370dff-0f58-4600-af78-3dd3610da87e:end--> Diese öffentlichen Stellen unterstützen Nutzer bei der Abwicklung von Verwaltungsleistungen im Portalverbund.
...
(3)Bei der Bereitstellung der IT-Komponenten im Sinne des Absatzes 1 <!--finding:9144f827-c455-4d61-a4b9-de4e524798b5:start-->sollen offene Standards und offene Schnittstellen verwendet werden und soll Open-Source-Software vorrangig vor solcher Software eingesetzt werden, deren Quellcode nicht öffentlich zugänglich ist oder deren Lizenz die Verwendung, Weitergabe und Veränderung einschränkt.<!--finding:9144f827-c455-4d61-a4b9-de4e524798b5:end-->
...
(1)<!--finding:e07aa823-9b05-4477-8f49-1965d2933101:start-->Bund und Länder stellen durch geeignete Maßnahmen die Nutzerfreundlichkeit sowie eine einfache und intuitive Bedienbarkeit des übergreifenden Zugangs zu elektronischen Verwaltungsleistungen, einschließlich der für diesen Zugang relevanten IT-Komponenten, sicher.<!--finding:e07aa823-9b05-4477-8f49-1965d2933101:end--> Nutzer sollen in die Entwicklung neuer elektronischer Angebote einbezogen werden.
...
(7)Auf Veranlassung des Nutzers ist eine dauerhafte Speicherung der Daten nach den Absätzen 1, 2, 5 und 6 zulässig. Im Falle der dauerhaften Speicherung muss der Nutzer jederzeit die Möglichkeit haben, das Nutzerkonto und alle gespeicherten Daten selbständig zu löschen. <!--finding:c8195291-b907-4cae-a23d-d6090e5b0f8e:start-->Das Bürgerkonto wird bei zweijähriger Inaktivität des Nutzers automatisch gelöscht. Der Nutzer wird zwei Monate vorher automatisch elektronisch über die anstehende Löschung benachrichtigt.<!--finding:c8195291-b907-4cae-a23d-d6090e5b0f8e:end--> Die elektronische Identifizierung kann jeweils mittels einer einmaligen Abfrage der Identitätsdaten erfolgen.
...
(1)Mit Einwilligung des Nutzers kann ein elektronischer Verwaltungsakt dadurch bekannt gegeben werden, dass er vom Nutzer oder seinem Bevollmächtigten über öffentlich zugängliche Netze von dessen Postfach nach § 2 Absatz 7, das Bestandteil eines Nutzerkontos nach § 2 Absatz 5 ist, abgerufen wird. <!--finding:3157087d-8b22-4bf0-bede-4f886045646f:start-->Die Einwilligung nach Satz 1 gilt als erteilt, sofern der Nutzer nicht im Rahmen der Inanspruchnahme einer elektronischen Verwaltungsleistung eine elektronische Bekanntgabe über ein Postfach im Sinne des § 2 Absatz 7 ausschließt.<!--finding:3157087d-8b22-4bf0-bede-4f886045646f:end--> Die Behörde hat zu gewährleisten, dass der Abruf nur nach Authentifizierung der berechtigten Person möglich ist und dass der elektronische Verwaltungsakt von dieser gespeichert werden kann. <!--finding:8d827856-36ba-4412-b484-f2865167665a:start-->Der Verwaltungsakt gilt am vierten Tag nach der Bereitstellung zum Abruf als bekannt gegeben.<!--finding:8d827856-36ba-4412-b484-f2865167665a:end--> Im Zweifel hat die Behörde für den Eintritt der Fiktionswirkung die Bereitstellung und den Zeitpunkt der Bereitstellung nachzuweisen. Der Nutzer oder sein Bevollmächtigter wird spätestens am Tag der Bereitstellung zum Abruf über die zu diesem Zweck von ihm angegebene Adresse über die Möglichkeit des Abrufs benachrichtigt. Erfolgt der Abruf vor einer erneuten Bekanntgabe des Verwaltungsaktes, bleibt der Tag des ersten Abrufs für den Zugang maßgeblich.
...
(3)Jede natürliche Person kann sich bei der öffentlichen Stelle, die das Datenschutzcockpit betreibt, für ein Datenschutzcockpit registrieren. <!--finding:d50117c5-ecd6-48f6-a2b5-368665c1d8dd:start-->Sie hat sich bei der Registrierung und Nutzung des Datenschutzcockpits mit einem Identifizierungsmittel auf dem Vertrauensniveau hoch zu identifizieren.<!--finding:d50117c5-ecd6-48f6-a2b5-368665c1d8dd:end--> Zur Feststellung der Identität darf bei Registrierung und Nutzung das dienste- und kartenspezifische Kennzeichen verarbeitet werden. Im Übrigen kann sich der Nutzer auch mit einem Nutzerkonto des Portalverbundes beim Datenschutzcockpit registrieren. In diesem Fall darf die für das Nutzerkonto zuständige Stelle das dienste- und kartenspezifische Kennzeichen an die für das Datenschutzcockpit zuständige Stelle übermitteln.
...
<!--finding:b4136441-179d-450d-949e-b20b233b3965:start-->Der Nutzer legt fest, in welchem Umfang das Datenschutzcockpit Protokolldaten einschließlich der übermittelten Inhaltsdaten sowie die Bestandsdaten der Register nach Absatz 2 erheben und anzeigen darf.<!--finding:b4136441-179d-450d-949e-b20b233b3965:end--> Auf diese Daten hat nur der Nutzer Zugriff. Der Nutzer muss sein Konto im Datenschutzcockpit jederzeit selbst löschen können. Das Konto im Datenschutzcockpit wird automatisiert gelöscht, wenn es drei Jahre nicht verwendet wurde.
...
(1)<!--finding:277448d9-17d8-4ad9-9003-302e1c975ef4:start--><!--finding:c1af5eaa-c3f4-49d1-9213-e6550b42f597:start-->Für einen Übergangszeitraum von drei Jahren kann die Identifizierung und Authentifizierung sowie die bidirektionale Kommunikation der Nutzer im Sinne des § 2 Absatz 4 Nummer 1 für elektronische Verwaltungsleistungen im Portalverbund auch über die bisherigen Nutzerkonten und Postfächer der Länder oder eines Fachportals erfolgen.<!--finding:c1af5eaa-c3f4-49d1-9213-e6550b42f597:end--><!--finding:277448d9-17d8-4ad9-9003-302e1c975ef4:end--> Die Frist nach Satz 1 beginnt an dem Tag, an dem das Bundesministerium des Innern und für Heimat im Einvernehmen mit dem IT-Planungsrat im Bundesgesetzblatt bekanntgibt, dass die Voraussetzungen für eine automatisierte Migration der Länderkonten auf das zentrale Bürgerkonto vorliegen. Das durch den Bund nach § 3 Absatz 1 Satz 1 bereitgestellte zentrale Bürgerkonto soll zu einer DeutschlandID weiterentwickelt werden.
...
(4)<!--finding:406402d1-4342-43c9-8e5e-71c20f3fd4fd:start-->Öffentliche Stellen sind von der Verpflichtung nach § 3 Absatz 3 bis einschließlich 31. Dezember 2031 ausgenommen in Bezug auf elektronische Verwaltungsleistungen, die der Durchführung<!--finding:406402d1-4342-43c9-8e5e-71c20f3fd4fd:end--> 
