...
name: Logos
fidelity: pro
link: https://www.knowledgetools.de
visualizations:
  - entscheidungsbaum
img:
  src: "@/images/werkzeugfinder/tools/logos_rulemap.png"
...
Login: [https://rulemapping.knowledgetools.de/rulemapping](https://rulemapping.knowledgetools.de/rulemapping)
