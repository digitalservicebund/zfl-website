  ...
  {#snippet sidebar1()}
    ...
    {#snippet feature2()}
      <Feature tag="Checks">
        ...
        {#snippet details()}
          <p>
            So berücksichtigen Sie automatisch notwendige Anforderungen wie den
    ...
    {#snippet feature3()}
      <Feature tag="KI">
        ...
        {#snippet details()}
          <p>So finden und ordnen Sie relevante Inhalte deutlich schneller.</p>
          <p>
            <strong>So arbeiten wir daran:</strong> Wir testen einen Prototypen,
            mit dem Sie Pflichten im Bestandsrecht schnell identifizieren und
